                                ...
                                child: MaterialButton(
                                  ...
                                  onPressed: () async {
                                    if(isVisible) {
                                      bool flag = false;
                                      if(widget.value == "Brand") {
                                        if(checkedBrand.values.contains(true)) {
                                          flag = true;
                                        }
                                        else {
                                        ...
                                        if(checkedFuel.values.contains(true)) {
                                          flag = true;
                                        }
                                        else {
                                          Fluttertoast.showToast(msg: "Select fuel Type");
                                        }
                                      }
                                      else if(widget.value == "Budget") {
                                        ...
                                        if(checkedBody.values.contains(true)) {
                                          flag = true;
                                        }
                                        else {
                                          Fluttertoast.showToast(msg: "Select body Type");
                                        }
                                      }
                                      if(flag) {
                                        isVisible = false;
